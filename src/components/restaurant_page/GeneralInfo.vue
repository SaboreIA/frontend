  ...
  <div class="p-6 max-w-4xl mx-auto">
    <div class="space-y-8">
      ...
      <section>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div v-if="contactInfo.site" class="flex items-center space-x-3">
            ...
            >
              {{ contactInfo.site.replace('http://', '').replace('https://', '') || 'SITE' }}
            </a>
          </div>
      ...
      <section>
        ...
        <p class="text-gray-700">{{ description || 'Nenhuma descrição detalhada fornecida.' }}</p>
      </section>
...
const props = defineProps({
  ...
  status: {
    type: Object,
    required: true,
    default: () => ({ text: 'INDISPONÍVEL', color: 'text-gray-400' })
  },
  ...
  description: {
    type: String,
    required: false,
    default: 'Nenhuma descrição detalhada fornecida.'
  }
});
</script>
