...
      }
      return 'Visitante'; // Alterado para 'Visitante' para refletir a lógica
    });
...
        // Comentado ou removido o console.log para evitar poluição do console
        return; 
      }
...
    
    scrollToSection(id) {
        console.log(`Simulando scroll para a seção: ${id}`);
    }
